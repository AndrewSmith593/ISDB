...
function addVeggie() {
	console.log("add veggie went off")
...
function saveSandwich() {
	...
	some ${sandwichDetails[2]}, hearty ${sandwichDetails[3]}, ${sandwichDetails[4]}, 
	and finally some ${sandwichDetails[5]}. Sounds Delicious! You used ${ingredientCount} ingredients.`;
